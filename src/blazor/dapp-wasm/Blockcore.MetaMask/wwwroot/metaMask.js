...
export async function listenToChangeEvents() {
    if (hasMetaMask()) {
        ...
        //    DotNet.invokeMethodAsync('Blockcore.AtomicSwaps.MetaMask', 'OnConnect');
        //});

        //ethereum.on("disconnect", function () {
        //    DotNet.invokeMethodAsync('Blockcore.AtomicSwaps.MetaMask', 'OnDisconnect');
        //});

        ethereum.on("accountsChanged", function (accounts) {
            DotNet.invokeMethodAsync('Blockcore.AtomicSwaps.MetaMask', 'OnAccountsChanged', accounts[0]);
        });

        ethereum.on("chainChanged", function (chainId) {
            DotNet.invokeMethodAsync('Blockcore.AtomicSwaps.MetaMask', 'OnChainChanged', chainId);
        });
    }
}
